...
В production Compose закреплены GPT-OSS-120B, пустой fallback и timeout 600 с;
переменные выбора модели из старого `PROD_ENV_FILE` больше их не переопределяют.
